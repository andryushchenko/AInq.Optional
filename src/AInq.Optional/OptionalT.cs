...
public readonly struct Optional<T> : IEquatable<Optional<T>>, IEquatable<T>, IComparable<Optional<T>>, IComparable<T>
{
    ...
    public static explicit operator Optional<T>(T item)
        => new(item, true);
